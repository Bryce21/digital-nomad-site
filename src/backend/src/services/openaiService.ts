...
type ValidBaseStructure = 'What are the popular foods of ' | 'What are popular things to do in '
...
function getMessageFromBaseAndPlace(base: ValidBaseStructure, place: string) {
    return base + place + '?' + 'Json response format: {"foods": [{"name": "", "description": ""}]}. 5 items'
}
